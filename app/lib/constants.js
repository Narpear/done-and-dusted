export const THEMES = {
  ...
  mocha: {
    name: 'Mocha',
    bg: 'bg-linear-to-br from-stone-950 via-stone-800 to-amber-950',
    accent: '#78350f',
    swatchGradient: 'linear-gradient(135deg, #0c0a09, #44403c, #1c0a00)',
    dark: true,
  },
  // ── Image themes ────────────────────────────────────────────────────────────
  'beach-sunset': {
  ...
  'clean-desk': {
    name: 'Clean Desk',
    bg: '',
    bgImage: '/themes/clean desk.jpg',
    accent: '#92400e',
    swatchGradient: 'url(/themes/clean%20desk.jpg) center/cover',
    dark: false,
    titleColor: '#1e3a8a',
    textColor: '#1f2937',
  },
  'forest-trail': {
    name: 'Forest Trail',
    bg: '',
    bgImage: '/themes/forest trail.jpg',
    accent: '#065f46',
    swatchGradient: 'url(/themes/forest%20trail.jpg) center/cover',
    dark: false,
    titleColor: '#78350f',
    textColor: '#78350f',
  },
  'mountain-sunrise': {
    ...
    bg: '',
    bgImage: '/themes/mountain sunrise.jpg',
    accent: '#c2410c',
    swatchGradient: 'url(/themes/mountain%20sunrise.jpg) center/cover',
    dark: false,
    titleColor: '#1e3a8a',
    textColor: '#1f2937',
  },
  'fantasy-cave': {
    name: 'Fantasy Cave',
    bg: '',
    bgImage: '/themes/fantasy cave.jpg',
    accent: '#6d28d9',
    swatchGradient: 'url(/themes/fantasy%20cave.jpg) center/cover',
    dark: false,
    titleColor: '#fef9c3',
    textColor: '#ffffff',
  },
  'rainy-window': {
    name: 'Rainy Window',
    bg: '',
    bgImage: '/themes/rainy window.jpg',
    accent: '#334155',
    swatchGradient: 'url(/themes/rainy%20window.jpg) center/cover',
    dark: false,
    titleColor: '#ffffff',
    textColor: '#ffffff',
  },
  'library-interior': {
    name: 'Library',
    bg: '',
    bgImage: '/themes/library interior.jpg',
    accent: '#92400e',
    swatchGradient: 'url(/themes/library%20interior.jpg) center/cover',
    dark: false,
    titleColor: '#fef9c3',
    textColor: '#ffffff',
  },
  'coffee-shop': {
    name: 'Coffee Shop',
    bg: '',
    bgImage: '/themes/coffee shop.jpg',
    accent: '#92400e',
    swatchGradient: 'url(/themes/coffee%20shop.jpg) center/cover',
    dark: false,
    titleColor: '#1c1917',
    textColor: '#1c1917',
  },
  'starry-night': {
    name: 'Starry Night',
    bg: '',
    bgImage: '/themes/starry night.jpg',
    accent: '#1d4ed8',
    swatchGradient: 'url(/themes/starry%20night.jpg) center/cover',
    dark: false,
    titleColor: '#fef9c3',
    textColor: '#ffffff',
  },
  'daytime-ocean': {
    name: 'Daytime Ocean',
    bg: '',
    bgImage: '/themes/daytime ocean.jpg',
    accent: '#0369a1',
    swatchGradient: 'url(/themes/daytime%20ocean.jpg) center/cover',
    dark: false,
    titleColor: '#1e3a8a',
    textColor: '#1f2937',
  },
  'cherry-blossom': {
    name: 'Cherry Blossom',
    bg: '',
    bgImage: '/themes/cherry blossom.jpg',
    accent: '#9d174d',
    swatchGradient: 'url(/themes/cherry%20blossom.jpg) center/cover',
    dark: false,
    titleColor: '#831843',
    textColor: '#4a044e',
  },
  'snowy-cabin': {
    name: 'Snowy Cabin',
    bg: '',
    bgImage: '/themes/snowy cabin.jpg',
    accent: '#3730a3',
    swatchGradient: 'url(/themes/snowy%20cabin.jpg) center/cover',
    dark: false,
    titleColor: '#1e1b4b',
    textColor: '#1e1b4b',
  },
  'ancient-castle': {
    name: 'Ancient Castle',
    bg: '',
    bgImage: '/themes/ancient castle.jpg',
    accent: '#b45309',
